...
# Attempt to import camelot and handle the error if it fails
try:
    import camelot
...
if not camelot_available:
    st.error("The `camelot` library is not installed. Please ensure it is included in your environment.")
else:
    # File uploader

...
Original file is located at
    https://colab.research.google.com/drive/1aJ5IA9xNgj-HnCMCPwY49HAYNzbPRd8r
"""
...
if pdf_files:
    ...
    for pdf_file in pdf_files:
        ...
        if output_format == "CSV":
            ...
            combined_tables.to_excel(f"extracted_tables/{file_name.split('.')[0]}_tables.xlsx", index=False)
            st.success(f"Tables from {file_name} saved as an Excel file.")
...
st.write("This app uses the `tabula-py` library to extract tables from PDF files.")
